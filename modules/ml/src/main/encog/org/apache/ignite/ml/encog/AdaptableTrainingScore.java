...
public class AdaptableTrainingScore implements CalculateScore {
    /**
     * The training set.
     */
     ...
     */
    public AdaptableTrainingScore(final MLDataSet training) {
    ...
    public double calculateScore(final MLMethod method) {
        return CalculateRegressionErrorAdaptable.calculateError((MLRegression)method, this.training);
    }
