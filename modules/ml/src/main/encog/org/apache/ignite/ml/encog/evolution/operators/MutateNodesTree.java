...
public class MutateNodesTree extends IgniteEvolutionaryOperator implements HasLearningRate {
    private int nodesToMutateCnt;
    private double learningRate;

    public MutateNodesTree(int nodesToMutateCnt, double prob, double learningRate, String operatorId) {
    ...
    @Override public void performOperation(Random rnd, Genome[] parents, int parentIndex, Genome[] offspring,
        ...
        TreeNetwork off = (TreeNetwork)parent.clone();
